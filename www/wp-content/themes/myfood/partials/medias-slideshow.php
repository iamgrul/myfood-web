<?php function get_medias_slideshow($images = null){
    ...
    ?>
    <div class="medias-slideshow__container__mobile display-mobile">
    ...
    <div class="medias-slideshow popin-content-container">
        ...
        <div class="medias-slideshow__container no-display-mobile">
        ...
        <div class="medias-slideshow__navigation no-display-mobile">
