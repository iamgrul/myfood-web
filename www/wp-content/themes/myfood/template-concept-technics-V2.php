<?php /* Template Name: Concept - Technics V2 */ ?>
...
<?php get_header(); ?>
    ...
    <main id="template-concept-technics" class="page-c">
        ...
        <section class="section page-c__section" id="technics-vertical-farming">
                    ...
                    <div class="grid-l__demi technics-tabs__tab">
                        <div class="technics-tabs__title">
                            <h3 class="title title--m green-text fade-in-bottom">
                                <?php the_field('rowsection_2_aquaponic_title'); ?>
                        ...
                        <div class="technics-tabs__layout">
                            ...
                            <img src="<?php get_img('/layouts/layout_aquaponic.png'); ?>" alt=""
                                 class="technics-tabs__layout__main hidden">
                        ...
                        <div class="technics-tabs__details mh-col">
                            <div class="technics-tabs__details__container">
                                <div class="technics-tabs__details__title title--tab green-text">
                                    <?php the_field('rowsection_2_aquaponic_subtitle'); ?>
                                </div>
                                <div class="common-text black-text">
                                    <?php the_field('rowsection_2_aquaponic_content'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid-l__demi technics-tabs__tab">
                        <div class="technics-tabs__title">
                            <h3 class="title title--m red-text fade-in-bottom-1">
                                <?php the_field('rowsection_2_bioponic_title'); ?>
                        ...
                        <div class="technics-tabs__layout">
                            ...
                            <img src="<?php get_img('/layouts/layout_bioponic.png'); ?>" alt=""
                                 class="technics-tabs__layout__main hidden">
                            <img src="<?php get_img('/layouts/layout_aerospring_zoom.png'); ?>" alt=""
                                 class="technics-tabs__layout__zoom--root  zoom-attraction">
                        ...
                        <div class="technics-tabs__details mh-col">
                            <div class="technics-tabs__details__container">
                                <div class="technics-tabs__details__title title--tab red-text">
                                    <?php the_field('rowsection_2_bioponic_subtitle'); ?>
                                </div>
                                <div class="common-text black-text">
                                    <p><?php the_field('rowsection_2_bioponic_content'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid-l page-c__section--dbl-layout__grid">
                ...
                <div class="grid-l__demi right-part">
                    <div class="layout">
                        ...
                        <img src="<?php get_img('/layouts/layout_perma.png'); ?>" alt=""
                             class="layout__img fade-in-bottom-2 hidden">
                        <img src="<?php get_img('/layouts/layout_perma_zoom.png'); ?>" alt=""
                             class="layout__zoom  zoom-attraction">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="grid-l study">
                <div class="grid-l__demi fade-in-bottom">
                    <div class="study__card">
                        ...
                        <a class="study__card__button" download
                           href="<?php the_field('rowsection_4_study1_buttonlink'); ?>">
                ...
                <div class="grid-l__demi study__content-container">
                    <div class="study__content fade-in-bottom-1">
                        ...
                        <a class="study__download-mobile" download
                           href="<?php the_field('rowsection_4_study1_buttonlink'); ?>">
                            <div class="download-button download-button--white">
                                <span class="download-button__points"></span>
                                <i class="download-button__icon icon-download"></i>
            ...
            <div class="grid-l study">
                <div class="grid-l__demi fade-in-bottom">
                    <div class="study__card">
                        ...
                        <a class="study__card__button" download
                           href="<?php the_field('rowsection_4_study2_buttonlink'); ?>">
                            <div class="download-button download-button--white">
                                <span class="download-button__points"></span>
                                <i class="download-button__icon icon-download"></i>
                            </div>
                ...
                <div class="grid-l">
                    <div class="grid-l__demi concept-bottom__part mh-col">
                        ...
                        <a class="concept-bottom__content fade-in-bottom"
                           href="<?php echo get_field('prefooter_left_link')['url']; ?>">
                    ...
                    <div class="grid-l__demi concept-bottom__part mh-col">
                        ...
                        <a class="concept-bottom__content fade-in-bottom-1"
                           href="<?php echo get_field('prefooter_right_link')['url']; ?>">
                            <h3 class="concept-bottom__content__title title--l white-text">
